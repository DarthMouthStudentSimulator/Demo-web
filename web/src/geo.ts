...
export const CAMPUS_PLACES: CampusPlace[] = [
  ...
  { key: "main building", label: "Main building", x: 0.51, y: 0.5, aliases: ["main building", "parkhurst", "administration"] },
  { key: "art center", label: "art center", x: 0.68, y: 0.64, aliases: ["hop", "hopkins", "art center", "hood", "museum"] },
  { key: "hall2", label: "hall 2", x: 0.62, y: 0.70, aliases: ["hall 2", "cummings", "engineering"] },
